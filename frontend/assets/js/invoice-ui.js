      ...
      <div class="p-5">
        ...
        <section data-invoice-panel="list" class="hidden">
          <div class="flex gap-3 mb-4">
            <input id="invoiceSearch" placeholder="بحث برقم الفاتورة أو اسم الموكل" class="flex-1 border rounded-lg p-3" />
            <select id="invoiceStatus" class="border rounded-lg p-3"><option value="">كل الحالات</option><option value="issued">صادرة</option><option value="partial">جزئية</option><option value="paid">مدفوعة</option><option value="cancelled">ملغاة</option></select>
            <button type="button" data-invoice-refresh class="bg-gray-100 px-4 rounded-lg">تحديث</button>
          </div>
